// function ResumeFormContactSection({ contactInformation }: ResumeState) {
//   return (
//     <ResumeFormSection
...
//     </CardHeader>
//     <CardContent>
//       {Object.keys(fields).map((dataField, j) => {
//         const fieldName =
//           `${dataField}` as keyof ResumeState["sections"][typeof i]["fields"];
//         const printName = titleCase(fieldName.split(".").pop() || "");
//         return (
//           <FormField
//             key={j}
...
//                   <Label htmlFor={field.name}>{printName}</Label>
//                   <Input
//                   // {...field}
        ...
        {/* <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder={form.formState.defaultValues?.resumeName}
                  {...field}
                />
              </FormControl>
              <FormDescription>This resume&apos;s name.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        /> */
