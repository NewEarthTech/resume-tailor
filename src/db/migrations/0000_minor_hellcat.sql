...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "user_display_name" ADD CONSTRAINT "user_display_name_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
